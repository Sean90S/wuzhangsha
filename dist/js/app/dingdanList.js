...
$(function(){
 ...
 /*       mui.init({
            pullRefresh : {
                container:"#allOrder",//待刷新区域标识，querySelector能定位的css选择器均可，比如：id、.class等
                up : {
...
function orderLoad() {
    ...
    $.post(URL, { accessToken: " ", version: " ",deviceType: "3",requestCode: "50001",member_id: 7,res_type: 0,showCount: 50,currentPag:1, state:"0"}, function (data) {
        console.log(data);
